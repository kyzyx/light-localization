...
const option::Descriptor usage[] =
{
    ...
    {INPUT_POINTCLOUD, 0, "", "pointcloud", filename,          "  --pointcloud points.txt\tUse precomputed medial axis points specified in points.txt"},
    ...
    {OUTPUT_POINTCLOUD, 0, "",  "outputpointcloud",   filename,  "  --outputpointcloud points,txt  \t"},
    {0,0,0,0,0,0}
};
#endif
